---
title: "Scale Quality"
description: "Курс для Senior QA та Lead-інженерів: побудуй QA-архітектуру та стратегію тестування за ISTQB CTAL-TM, ISO 29119, DORA та CT-AI. 35 занять, 8 блоків, Capstone-захист."
date: 2026-06-22
draft: false
layout: "landing"
...
audience:
  ...
  intro: "Якщо ти добре тестуєш, але відчуваєш, що ріст впирається в невидиму стелю — цей курс для тебе."
  cards:
    - role: "Senior QA → Lead"
...
competencies:
  ...
  items:
    - label: "Architecture-to-risk"
      text: "Читати архітектуру системи (monolith, microservices, cloud-native) і перетворювати її на карту ризиків і тест-рівнів — ти бачиш проблеми до того, як їх побачили розробники."
    ...
    - label: "Governance & OKR"
      text: "Проєктувати QA-функцію (CoE, RACI), каскадувати OKR/KPI і вести working agreements — ти керуєш якістю організаційно, а не тільки технічно."
    - label: "Стратегічний вплив"
      text: "Комунікувати ризик executives мовою бізнесу і захищати trade-offs перед steering committee — тебе запрошують на архітектурні рев'ю і слухають на рівні C-level."
...
final_project:
  ...
  intro: "Протягом курсу ти будуєш реальний board-ready пакет для свого поточного проєкту — не навчальний кейс, а робочий артефакт, з яким ти виходиш на наступну роль. 19 deliverables, єдиний захист:"
  items:
...
faq:
  ...
  items:
    - q: "Я вже QA Lead — чи підійде мені цей курс?"
      a: "Так. Курс розроблений саме для тих, хто вже в Lead-ролі або впритул до неї. Якщо ти виконуєш роботу лідера, але ще не маєш системних інструментів (стратегія, governance, OKR, C-level комунікація) — ти в правильному місці."
    - q: "Курс для продуктових компаній чи аутсорсу?"
      a: "Для обох. Блоки з архітектурного аналізу ризиків і стратегії тестування однаково актуальні для product і outsource. Блок 3 (Discovery) та Block 0 (Outsourcing vs product) дають окремий фрейм для сервісних компаній."
    - q: "Чи потрібна технічна база — автоматизація, код?"
      a: "Ні. Курс орієнтований на стратегію, архітектуру та управління, а не на написання тестів. Базове розуміння SDLC і тестування — достатньо."
    - q: "Скільки часу потрібно на тиждень?"
      a: "2–3 год на живе заняття + 2–4 год на домашнє завдання (Capstone-артефакт для свого проєкту). Загалом 4–7 год/тиждень."
    - q: "Що якщо я пропущу заняття?"
      a: "Кожне заняття записується. Запис доступний одразу після заняття. Домашнє завдання можна здати з відставанням на 1 тиждень без штрафів."
    - q: "Чи є сертифікат після завершення?"
      a: "Так, сертифікат про проходження курсу. Але головний результат — це Capstone-пакет: реальний board-ready артефакт, який ти захищаєш і кладеш у портфоліо."
    - q: "Коли старт і скільки людей у групі?"
      a: "Групи малі — деталі про старт і розмір групи уточнюються індивідуально. Залиши контакт — я напишу особисто."
...
pricing:
  ...
  meta: "8 блоків · 35 занять · ~33 тижні"
  ...
  includes:
    ...
    - "Шаблони, canvas, чеклисти для всіх 19 артефактів"
...
bottom_cta:
  text: "Ти вже знаєш, що наступний крок — це не ще один проєкт як виконавець. Залиши контакт — поговоримо про старт і формат."
---
...
Але гроші — це наслідок. Справжня зміна — це коли тебе починають запрошувати на рішення, а не просто виконання. Коли твій голос впливає на архітектуру, бюджет і напрямок команди.
