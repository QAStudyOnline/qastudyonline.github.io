...
**Практика на занятті:** студенти налаштовують простий GitHub Actions workflow: при зміні файлів промптів агент автоматично генерує оновлені тест-кейси й відкриває PR з ними. (створення двох агентних воркфлоу на базы clade code or gh copilot or cursor or codex)
